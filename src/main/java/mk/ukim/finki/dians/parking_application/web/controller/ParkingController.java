...
//    @PreAuthorize("hasRole('ROLE_ADMIN')")
    ...
    public String saveParking(
        ...
        if (id != null) {
            this.parkingService.edit(id, name, city, address, Double.parseDouble(latitude), Double.parseDouble(longitude), rating);
        } else {
            this.parkingService.save(name, city, address,Double.parseDouble(latitude), Double.parseDouble(longitude), rating);
        }
        return "redirect:/parking/all-parkings";
    }
}
